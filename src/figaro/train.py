...
def main():
    ...
    if CHECKPOINT:
        ...
        model = {
            ...
            "figaro-expert": lambda: Seq2SeqModule(description_flavor="description", **seq2seq_kwargs),
            ...
            "baseline": lambda: Seq2SeqModule(description_flavor="none", **dec_kwargs),
        }[MODEL]()

    datamodule = model.get_datamodule(
        midi_files, vae_module=vae_module, batch_size=BATCH_SIZE, num_workers=N_WORKERS, pin_memory=True
    )
